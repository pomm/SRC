...
void Plots(){
  ...
  SetRootPalette(1);
    ...
    TH2F* theta_P_p_MF_90 = new TH2F("theta_P_p_MF_90","; |P_{#pi}| [GeV/c]; #theta_{#pi} [degrees]",24,0,12 , 70,5,75);
    TH2F* theta_P_pi_MF_90 = new TH2F("theta_P_pi_MF_90","; |P_{p}| [GeV/c]; #theta_{p} [degrees]",24,0,12 , 70,5,75);
    TH2F* theta_Ppi_MF_90 = new TH2F("theta_Ppi_MF_90","; #theta_{p} [GeV/c]; #theta_{#pi} [degrees]",70,5,75 , 70,5,75);
    TH1F* phi_MF_90 = new TH1F("phi_MF_90","; #phi_{#pi} - #phi_{p} [degrees]",40,160,200);
    TCanvas C1;
    C1.Divide(2,2);
    C1.cd(1);
    T->Draw("theta_P3:P3>>theta_P_p_MF_90"      , "weight_kk*(TMath::Abs(t)>3&&TMath::Abs(u)>3&&Precoil<0.1&&TMath::Abs(theta_cm-90)<10)","col");
    C1.cd(2);
    T->Draw("theta_P4:P4>>theta_P_pi_MF_90"      , "weight_kk*(TMath::Abs(t)>3&&TMath::Abs(u)>3&&Precoil<0.1&&TMath::Abs(theta_cm-90)<10)","col");
    C1.cd(3);
    T->Draw("theta_P4:theta_P3>>theta_Ppi_MF_90", "weight_kk*(TMath::Abs(t)>3&&TMath::Abs(u)>3&&Precoil<0.1&&TMath::Abs(theta_cm-90)<10)","col");
    C1.cd(4);
    ...
    */
    ...
    TH2F* theta_P_p_MF_All = new TH2F("theta_P_p_MF_All","; |P_{p}| [GeV/c]; #theta_{p} [degrees]",24,0,12 , 70,5,75);
    theta_P_p_MF_All->SetXTitle("|P_{p}| [GeV/c]");
    theta_P_p_MF_All->SetYTitle("#theta_{p} [degrees]");
    TH2F* theta_P_pi_MF_All = new TH2F("theta_P_pi_MF_All","; |P_{#pi}| [GeV/c]; #theta_{#pi} [degrees]",24,0,12 , 70,5,75);
    theta_P_pi_MF_All->SetXTitle("|P_{#pi}| [GeV/c]");
    theta_P_pi_MF_All->SetYTitle("#theta_{#pi} [degrees]");
    TH2F* theta_Ppi_MF_All = new TH2F("theta_Ppi_MF_All","; #theta_{p} [degrees]; #theta_{#pi} [degrees]",70,5,75 , 70,5,75);
    ...
    C2.Divide(2,2);
    C2.cd(1);
    T->Draw("theta_P4:P4>>theta_P_pi_MF_All"      , "weight_kk*(TMath::Abs(t)>3&&TMath::Abs(u)>3&&Precoil<0.1)","colz");
    C2.cd(2);
    T->Draw("theta_P3:P3>>theta_P_p_MF_All"      , "weight_kk*(TMath::Abs(t)>3&&TMath::Abs(u)>3&&Precoil<0.1)","colz");
    C2.cd(3);
    ...
    // SRC. Theta c.m. = 90
    TH2F* theta_P_p_SRC_90 = new TH2F("theta_P_p_SRC_90","; |P_{p}| [GeV/c]; #theta_{p} [degrees]",24,0,12 , 70,5,75);
    theta_P_p_SRC_90->SetXTitle("|P_{p}| [GeV/c]");
    theta_P_p_SRC_90->SetYTitle("#theta_{p} [degrees]");
    TH2F* theta_P_pi_SRC_90 = new TH2F("theta_P_pi_SRC_90","; |P_{#pi}| [GeV/c]; #theta_{#pi} [degrees]",24,0,12 , 70,5,75);
    theta_P_pi_SRC_90->SetXTitle("|P_{#pi}| [GeV/c]");
    theta_P_pi_SRC_90->SetYTitle("#theta_{#pi} [degrees]");
    TH2F* theta_Ppi_SRC_90 = new TH2F("theta_Ppi_SRC_90","; #theta_{p} [degrees]; #theta_{#pi} [degrees]",70,5,75 , 70,5,75);
    ...
    C3.Divide(2,2);
    C3.cd(1);
    T->Draw("theta_P4:P4>>theta_P_p_SRC_90","weight_kk*(TMath::Abs(t)>3&&TMath::Abs(u)>3&&Precoil>0.1&&theta_recoil<160&&Precoil>0.3&&TMath::Abs(theta_cm-90)<10)*0.5*0.8","col");
    C3.cd(2);
    T->Draw("theta_P3:P3>>theta_P_pi_SRC_90",           "weight_kk*(TMath::Abs(t)>3&&TMath::Abs(u)>3&&Precoil>0.1&&theta_recoil<160&&Precoil>0.3&&TMath::Abs(theta_cm-90)<10)*0.5*0.8","col");
    C3.cd(3);
    T->Draw("theta_P4:theta_P3>>theta_Ppi_SRC_90",      "weight_kk*(TMath::Abs(t)>3&&TMath::Abs(u)>3&&Precoil>0.1&&theta_recoil<160&&Precoil>0.3&&TMath::Abs(theta_cm-90)<10)*0.5*0.8","col");
    C3.cd(4);
    ...
    // SRC. Theta c.m. = All
    TH2F* theta_P_p_SRC_All = new TH2F("theta_P_p_SRC_All","; |P_{p}| [GeV/c]; #theta_{p} [degrees]",24,0,12 , 70,5,75);
    theta_P_p_SRC_All->SetXTitle("|P_{p}| [GeV/c]");
    theta_P_p_SRC_All->SetYTitle("#theta_{p} [degrees]");
    TH2F* theta_P_pi_SRC_All = new TH2F("theta_P_pi_SRC_All","; |P_{#pi}| [GeV/c]; #theta_{#pi} [degrees]",24,0,12 , 70,5,75);
    theta_P_pi_SRC_All->SetXTitle("|P_{#pi}| [GeV/c]");
    theta_P_pi_SRC_All->SetYTitle("#theta_{#pi} [degrees]");
    TH2F* theta_Ppi_SRC_All = new TH2F("theta_Ppi_SRC_All","; #theta_{p} [degrees]; #theta_{#pi} [degrees]",70,5,75 , 70,5,75);
    ...
    C4.Divide(2,2);
    C4.cd(1);
    T->Draw("theta_P4:P4>>theta_P_pi_SRC_All","weight_kk*(TMath::Abs(t)>3&&TMath::Abs(u)>3&&Precoil>0.1&&theta_recoil<160&&Precoil>0.3)*0.5*0.8","colz");
    C4.cd(2);
    T->Draw("theta_P3:P3>>theta_P_p_SRC_All","weight_kk*(TMath::Abs(t)>3&&TMath::Abs(u)>3&&Precoil>0.1&&theta_recoil<160&&Precoil>0.3)*0.5*0.8","colz");
    C4.cd(3);
