...
void Gen_gn_pipm(int N = 10000, int A = 2, bool printOutput = false){
  ...
  Double_t theta_recoil, phi_recoil, Precoil;
  Double_t theta_miss, phi_miss, Pmiss;
  Double_t theta_P3, phi_P3, absP3;
  Double_t theta_P4, phi_P4, absP4;
  TVector3 P3, P4;
  Double_t t,u,s;
  Double_t theta_cm;
  Double_t weight;
  ...
  */
  ...
  for (int i=0; i<N; i++){
    ...
    for(int k=0; k<17; k++){
      ...
      Double_t rot_theta = Vbeam_cm.Vect().Theta();
