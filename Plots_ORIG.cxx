{
    ...
    gStyle->SetOptStat(0);
    //    TTree* T = ((TTree*)(TFile::Open("FullMC_Gluex_9GeV_ORIGINAL.root")->Get("T")));
    //    TTree* T = ((TTree*)(TFile::Open("FullMC_Gluex_9GeV_N100k.root")->Get("T")));
    ...
    C1.Divide(2,2);
    C1.cd(1);
    T->Draw("theta_P1:P1>>theta_P_p_MF_90"      , "weight*(TMath::Abs(t)>3&&TMath::Abs(u)>3&&P_recoil<0.1&&TMath::Abs(theta_cm-90)<10)","col");
    C1.cd(2);
    T->Draw("theta_P2:P2>>theta_P_pi_MF_90"      , "weight*(TMath::Abs(t)>3&&TMath::Abs(u)>3&&P_recoil<0.1&&TMath::Abs(theta_cm-90)<10)","col");
    C1.cd(3);
    T->Draw("theta_P2:theta_P1>>theta_Ppi_MF_90", "weight*(TMath::Abs(t)>3&&TMath::Abs(u)>3&&P_recoil<0.1&&TMath::Abs(theta_cm-90)<10)","col");
    C1.cd(4);
    ...
    C2.Divide(2,2);
    C2.cd(1);
    T->Draw("theta_P1:P1>>theta_P_p_MF_All"      , "weight*(TMath::Abs(t)>3&&TMath::Abs(u)>3&&P_recoil<0.1)","col");
    C2.cd(2);
    T->Draw("theta_P2:P2>>theta_P_pi_MF_All"      , "weight*(TMath::Abs(t)>3&&TMath::Abs(u)>3&&P_recoil<0.1)","col");
    C2.cd(3);
    T->Draw("theta_P2:theta_P1>>theta_Ppi_MF_All", "weight*(TMath::Abs(t)>3&&TMath::Abs(u)>3&&P_recoil<0.1)","col");
    C2.cd(4);
    ...
    C3.Divide(2,2);
    C3.cd(1);
    T->Draw("theta_P1:P1>>theta_P_p_SRC_90",            "weight*(TMath::Abs(t)>3&&TMath::Abs(u)>3&&P_recoil>0.1&&theta_recoil<160&&P_recoil>0.3&&TMath::Abs(theta_cm-90)<10)*0.5*0.8","col");
    C3.cd(2);
    T->Draw("theta_P2:P2>>theta_P_pi_SRC_90",           "weight*(TMath::Abs(t)>3&&TMath::Abs(u)>3&&P_recoil>0.1&&theta_recoil<160&&P_recoil>0.3&&TMath::Abs(theta_cm-90)<10)*0.5*0.8","col");
    C3.cd(3);
    T->Draw("theta_P2:theta_P1>>theta_Ppi_SRC_90",      "weight*(TMath::Abs(t)>3&&TMath::Abs(u)>3&&P_recoil>0.1&&theta_recoil<160&&P_recoil>0.3&&TMath::Abs(theta_cm-90)<10)*0.5*0.8","col");
    C3.cd(4);
    ...
    C4.Divide(2,2);
    C4.cd(1);
    T->Draw("theta_P1:P1>>theta_P_p_SRC_All"                ,         "weight*(TMath::Abs(t)>3&&TMath::Abs(u)>3&&P_recoil>0.1&&theta_recoil<160&&P_recoil>0.3)*0.5*0.8","col");
    C4.cd(2);
    T->Draw("theta_P2:P2>>theta_P_pi_SRC_All"                ,        "weight*(TMath::Abs(t)>3&&TMath::Abs(u)>3&&P_recoil>0.1&&theta_recoil<160&&P_recoil>0.3)*0.5*0.8","col");
    C4.cd(3);
    T->Draw("theta_P2:theta_P1>>theta_Ppi_SRC_All"          ,         "weight*(TMath::Abs(t)>3&&TMath::Abs(u)>3&&P_recoil>0.1&&theta_recoil<160&&P_recoil>0.3)*0.5*0.8","col");
    C4.cd(4);
